# Plan — Dashboard Device Targeting (Spec 014)
...
- Add a “Set Active” action & visual highlight to each device card.
...
## Workstream 3 — Module Integration
